...
const p_calendarTemplate4 = (rowData, { rowIndex }) => <p >{rowData.createdAt}</p>
...
<Column field="createdAt" header="CreatedAt" body={p_calendarTemplate4} filter={selectedFilterFields.includes("createdAt")} hidden={selectedHideFields?.includes("createdAt")}  sortable style={{ minWidth: "8rem" }} />
