...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="createdAt"  value={_entity?.createdAt ? new Date(_entity?.createdAt) : new Date()} dateFormat="dd/mm/yy" onChange={ (e) => setValByKey("createdAt", new Date(e.target.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
