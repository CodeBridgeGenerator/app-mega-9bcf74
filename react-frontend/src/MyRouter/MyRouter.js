...
import SingleReviewDetailsPage from "../components/app_components/ReviewDetailsPage/SingleReviewDetailsPage";
import ReviewDetailProjectLayoutPage from "../components/app_components/ReviewDetailsPage/ReviewDetailProjectLayoutPage";
//  ~cb-add-import~
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute redirectPath={"/login"} />}>
        ...
        />
<Route path="/reviewDetails/:singleReviewDetailsId" exact element={<SingleReviewDetailsPage />} />
<Route path="/reviewDetails" exact element={<ReviewDetailProjectLayoutPage />} />
